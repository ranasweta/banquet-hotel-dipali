  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        <KpiTile href="/day-sheet" icon={<CalendarDays className="size-5" aria-hidden />} value={today.length} label="Functions today" tone={today.length ? 'blue' : 'slate'} />
        ...
        <KpiTile href="/day-sheet" icon={<UtensilsCrossed className="size-5" aria-hidden />} value={menuGaps.length} label="Menus to finalise" tone={menuGaps.length ? 'amber' : 'emerald'} />
      </div>
